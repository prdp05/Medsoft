...
<div class="search-bar">
    ...
    <button type="button" onclick="searchMedicine()"><i class="fa-solid fa-magnifying-glass"></i> Search</button>
</div>
...
<table class="medicineTable" id="medicineTable">
    ...
    <tr>
        ...
        <td><button type="button" onclick="openModal()"><i class="fa-solid fa-capsules"></i> Sales</button></td>
...
<!--            <div class="rmk-proc">-->
            ...
            <button type="button" onclick="openSubmitEntry()">Process</button>
<!--            </div>-->
        </form>
        </div>
    </div>
