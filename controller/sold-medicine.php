...
//}
//
//$soldDataSql = "SELECT * FROM medicines where SN = $medId";
//$done = $conn-> query($soldDataSql);
////     Insert into database or perform any necessary actions
//     $sql = "INSERT INTO soldmedicine (MED_ID, QUANTITY, DISCOUNT, REMARK) VALUES ('$medId', '$quantity', '$discount', '$remark')";
//     $done = $conn->query($sql);
